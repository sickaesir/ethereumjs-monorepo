...
export interface TrieInterface {
   ...
   */
  findPath(keyNibbles: Nibble[]): Promise<{ stack: TNode[]; remainingNibbles: Nibble[] }>
   ...
   */
  _storeNode(node: TNode): Promise<void>
   ...
   */
  _getNode(node: TNode, key: Uint8Array): Promise<TNode | null>
   ...
   */
  _update(keyNibbles: Nibble[], value: Uint8Array | null): Promise<Uint8Array>
}
